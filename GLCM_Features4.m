...
% GLCMs
%
% Author: Avinash Uppuluri: avinash_uv@yahoo.com: Last modified: 04/05/2010
...
% checked 
%out.autoc = zeros(1,size_glcm_3); % Autocorrelation: [2]  Soh 
out.contr = zeros(1,size_glcm_3); % Contrast: matlab/[1,2] - Soh/Haralick
out.corrm = zeros(1,size_glcm_3); % Correlation: matlab - Soh/Haralick
%out.corrp = zeros(1,size_glcm_3); % Correlation: [1,2] - Soh/Haralick
%out.cprom = zeros(1,size_glcm_3); % Cluster Prominence: [2] -Soh
%out.cshad = zeros(1,size_glcm_3); % Cluster Shade: [2] - Soh
%out.dissi = zeros(1,size_glcm_3); % Dissimilarity: [2] - Soh
out.energ = zeros(1,size_glcm_3); % Energy: matlab / [1,2] - Soh/Haralick
out.entro = zeros(1,size_glcm_3); % Entropy: [2] - Soh/Haralick
out.homom = zeros(1,size_glcm_3); % Homogeneity: matlab - Soh/Haralick
%out.homop = zeros(1,size_glcm_3); % Homogeneity: [2] - Soh/Haralick
%out.maxpr = zeros(1,size_glcm_3); % Maximum probability: [2] - Soh
...
%out.invdc = zeros(1,size_glcm_3);% Inverse difference (INV) is homom [3] Clausi
%out.indnc = zeros(1,size_glcm_3); % Inverse difference normalized (INN) [3] Clausi
%out.idmnc = zeros(1,size_glcm_3); % Inverse difference moment normalized [3] Clausi
...
%     out.indnc(k) = sum(sum(glcm(:,:,k)./( 1 + (mul_dissi./size_glcm_1)))); %NON DOVREBBE ESSERTE AL QUADRATO COME SOTTO? 
